...
class AddScheduleState extends State<AddSchedule> {
  ...
  Future<void> _fetchGroupUsers() async {
    try {
      final groupDoc =
          FirebaseFirestore.instance.collection('group').doc(widget.groupId);
                              ...
                              ? () async {
                                  try {
                                    ...
                                    final newSchedule = {
                                      ...
                                      'schedule_user':
                                          scheduleUser, // 선택된 친구 목록
                                      'title':
                                          _scheduleNameController.text, // 일정 이름
                                    };
                                    ...
                                    await groupDoc
                                        .update({'schedule': existingSchedule});
