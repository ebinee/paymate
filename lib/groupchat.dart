...
class GroupChatState extends State<GroupChat> {
  ...
  double calculateTotalAmount(
      String userUid, List<Map<String, dynamic>> schedules) {
    ...
    try {
      ...
      FirebaseFirestore.instance
        ...
        if (groupDoc.exists) {
          ...
          List<Map<String, dynamic>> fetchedGroupUsers = users.map((groupuser) {
            return {
              'Uid': groupuser['Uid'],
              'name': groupuser['name'],
            };
                ...
                child: Row(
                  children: [
                    ...
                    ...groupuser
                        ...
                        .map((profile) {
                      final userTotalAmount =
                          calculateTotalAmount(profile['Uid'], schedule);
      ...
      bottomNavigationBar: schedule.isNotEmpty
          ? Padding(
              padding: const EdgeInsets.only(
                  bottom: 16.0,
                  left: 100.0,
                  right: 100.0), // 아래쪽 여백만 조정하고 양옆 여백도 추가
